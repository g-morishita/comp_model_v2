"""Stan adapter for the non-sticky social demo-action bias RL kernel."""
...
class SocialRlDemoActionBiasStanAdapter:
    ...
    def build_stan_data(
        ...
        """Build Stan data for the non-sticky demo-action bias programs."""
