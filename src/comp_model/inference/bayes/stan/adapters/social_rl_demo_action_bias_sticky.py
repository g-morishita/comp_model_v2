"""Stan adapter for the sticky social demo-action bias RL kernel."""
...
class SocialRlDemoActionBiasStickyStanAdapter:
    """Stan adapter for the sticky social demo-action bias RL kernel."""

    def kernel_spec(self) -> ModelKernelSpec:
        """Return the kernel specification served by this adapter."""

        return SocialRlDemoActionBiasStickyKernel.spec()
    ...
    def build_stan_data(
        ...
        """Build Stan data for the sticky demo-action bias programs."""
    ...
    def population_param_names(self, hierarchy: HierarchyStructure) -> tuple[str, ...]:
        ...
        if hierarchy == HierarchyStructure.STUDY_SUBJECT_BLOCK_CONDITION:
            return (
                "mu_demo_bias_shared_z",
                "sd_demo_bias_shared_z",
                "mu_stickiness_shared_z",
                "sd_stickiness_shared_z",
                "mu_demo_bias_delta_z",
                "sd_demo_bias_delta_z",
                "mu_stickiness_delta_z",
                "sd_stickiness_delta_z",
                "demo_bias_pop",
                "stickiness_pop",
                "demo_bias_shared_pop",
