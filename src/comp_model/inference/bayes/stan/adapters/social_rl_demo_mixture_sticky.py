"""Stan adapter for the sticky social demonstrator-only mixture RL kernel."""
...
class SocialRlDemoMixtureStickyStanAdapter:
    ...
    def build_stan_data(
        ...
        kernel: SocialRlDemoMixtureStickyKernel | None = None,
    ) -> dict[str, Any]:
        """Build Stan data for the sticky demonstrator-only mixture programs."""
