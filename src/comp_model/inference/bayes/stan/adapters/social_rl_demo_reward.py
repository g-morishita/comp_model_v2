"""Stan adapter for the social demonstrator-reward-only RL kernel."""
...
class SocialRlDemoRewardStanAdapter:
    ...
    def build_stan_data(
        ...
        """Build Stan data for the demonstrator-reward-only social RL programs."""
