"""Stan adapter for the sticky social self-reward + demo-action mixture RL kernel."""
...
class SocialRlSelfRewardDemoActionMixtureStickyStanAdapter:
    """Stan adapter for the sticky social self-reward + demo-action mixture RL kernel."""

    def kernel_spec(self) -> ModelKernelSpec:
        """Return the kernel specification served by this adapter."""

        return SocialRlSelfRewardDemoActionMixtureStickyKernel.spec()
    ...
    def build_stan_data(
        ...
        kernel: SocialRlSelfRewardDemoActionMixtureStickyKernel | None = None,
    ) -> dict[str, Any]:
        """Build Stan data for the sticky self-reward + demo-action mixture programs."""
