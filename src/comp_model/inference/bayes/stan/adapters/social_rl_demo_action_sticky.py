"""Stan adapter for the sticky social demo-action RL kernel."""
...
class SocialRlDemoActionStickyStanAdapter:
    ...
    def build_stan_data(
        ...
        """Build Stan data for the sticky demo-action programs."""
    ...
    def subject_param_names(self) -> tuple[str, ...]:
        ...
        return ("alpha_other_action", "beta", "stickiness")
