"""Stan adapter for the sticky social self-reward + demo-reward RL kernel."""
...
class SocialRlSelfRewardDemoRewardStickyStanAdapter:
    """Stan adapter for the sticky social self-reward + demo-reward RL kernel."""

    def kernel_spec(self) -> ModelKernelSpec:
        """Return the kernel specification served by this adapter."""

        return SocialRlSelfRewardDemoRewardStickyKernel.spec()
    ...
    def build_stan_data(
        ...
        """Build Stan data for the sticky self-reward + demo-reward programs."""
    ...
    def subject_param_names(self) -> tuple[str, ...]:
        ...
        return ("alpha_self", "alpha_other", "beta", "stickiness")
