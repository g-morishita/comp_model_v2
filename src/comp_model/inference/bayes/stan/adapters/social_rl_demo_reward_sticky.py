"""Stan adapter for the sticky social demonstrator-reward-only RL kernel."""
...
class SocialRlDemoRewardStickyStanAdapter:
    ...
    def build_stan_data(
        ...
        """Build Stan data for the sticky demonstrator-reward social RL programs."""
    ...
    def subject_param_names(self) -> tuple[str, ...]:
        ...
        return ("alpha_other", "beta", "stickiness")
