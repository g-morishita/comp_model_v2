 ...
 * Parameters: alpha_other_outcome[N][C], alpha_other_action[N][C],
 ...
 * All four parameters are built from a subject-level baseline plus a condition delta, both drawn
