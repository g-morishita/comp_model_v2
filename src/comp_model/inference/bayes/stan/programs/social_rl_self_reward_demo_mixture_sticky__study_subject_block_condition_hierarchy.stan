...
data {
  ...
  int alpha_other_outcome_delta_prior_family;   // prior family code for the group-level alpha_other_outcome delta means
  real alpha_other_outcome_delta_prior_p1;      // first hyperparameter of the alpha_other_outcome delta prior
  real alpha_other_outcome_delta_prior_p2;      // second hyperparameter of the alpha_other_outcome delta prior
  real alpha_other_outcome_delta_prior_p3;      // third hyperparameter of the alpha_other_outcome delta prior
  ...
  int alpha_other_action_delta_prior_family;    // prior family code for the group-level alpha_other_action delta means
  real alpha_other_action_delta_prior_p1;       // first hyperparameter of the alpha_other_action delta prior
  real alpha_other_action_delta_prior_p2;       // second hyperparameter of the alpha_other_action delta prior
  real alpha_other_action_delta_prior_p3;       // third hyperparameter of the alpha_other_action delta prior
  ...
  int w_imitation_delta_prior_family;     // prior family code for the group-level w_imitation delta means
  real w_imitation_delta_prior_p1;        // first hyperparameter of the w_imitation delta prior
  real w_imitation_delta_prior_p2;        // second hyperparameter of the w_imitation delta prior
  real w_imitation_delta_prior_p3;        // third hyperparameter of the w_imitation delta prior
  ...
  int stickiness_delta_prior_family;      // prior family code for the group-level stickiness delta means
  real stickiness_delta_prior_p1;         // first hyperparameter of the stickiness delta prior
  real stickiness_delta_prior_p2;         // second hyperparameter of the stickiness delta prior
  real stickiness_delta_prior_p3;         // third hyperparameter of the stickiness delta prior
...
model {
  ...
  for (e in 1:E) {
    ...
    if (step_social_action[e] > 0) {
      ...
      T[n] = (1 - alpha_other_action[n][cc]) * T[n];                                     // decay all action tendencies toward 0
      T[n][sa] = T[n][sa] + alpha_other_action[n][cc];                                    // chosen action gets the toward-1 increment
    }
  }
}
