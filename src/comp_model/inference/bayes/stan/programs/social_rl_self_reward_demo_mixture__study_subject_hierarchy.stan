 ...
 * Parameters: alpha_self[N], alpha_other_outcome[N], alpha_other_action[N], w_imitation[N], beta[N]
 ...
 * All five parameters are drawn from group-level normal distributions in unconstrained space
...
model {
  ...
  for (e in 1:E) {
    ...
    // OWN-OUTCOME UPDATE: Rescorla-Wagner update on Q with subject n's alpha_self
