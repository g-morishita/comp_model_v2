 ...
 * Parameters: alpha_self, alpha_other_action, w_imitation, beta
 *
 * Mixture social Q-learning for a single subject that learns from own outcomes and a
 * demonstrator's actions. Two independent value systems are maintained:
 * Q (outcome values) updated by self rewards, and T (action tendencies)
