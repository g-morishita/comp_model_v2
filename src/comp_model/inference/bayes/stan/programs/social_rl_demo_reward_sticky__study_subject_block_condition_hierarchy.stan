/*
 * Model: Social RL — Demonstrator Reward Only with Stickiness
 * Hierarchy: Study-subject-block-condition
 * Parameters: alpha_other[N][C], beta[N][C], stickiness[N][C]
 */
functions {
...
data {
  ...
  int alpha_other_delta_prior_family;
  real alpha_other_delta_prior_p1;
  real alpha_other_delta_prior_p2;
  real alpha_other_delta_prior_p3;
  ...
  int sd_alpha_other_delta_prior_family;
  real sd_alpha_other_delta_prior_p1;
  real sd_alpha_other_delta_prior_p2;
  real sd_alpha_other_delta_prior_p3;
...
transformed parameters {
  vector[N] alpha_other_shared_z =
      mu_alpha_other_shared_z + sd_alpha_other_shared_z * raw_alpha_other_shared_z;
  ...
  for (d in 1:(C - 1)) {
    alpha_other_delta_z[d] =
        mu_alpha_other_delta_z[d] + sd_alpha_other_delta_z[d] * raw_alpha_other_delta_z[d];
...
generated quantities {
  ...
  vector<lower=0,upper=1>[C] alpha_other_pop;
  vector<lower=0>[C] beta_pop;
  vector[C] stickiness_pop;
  real alpha_other_shared_pop;
