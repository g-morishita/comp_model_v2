...
Start with [models/README.md](models/README.md).

## Structure

- `models/`: one directory per model, with fixed scripts for the main workflows
- `model_recovery/`: model-comparison and recovery studies
