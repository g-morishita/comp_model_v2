"""Parameter recovery for social demonstrator-reward learning using
hierarchical Stan.

Recovers per-subject parameters (alpha_other, beta) under a hierarchical
(STUDY_SUBJECT) model with population-level priors. Uses a
pre-choice demonstrator observation schema with a uniform demonstrator policy.

Usage:
    uv run python example/social_rl_demo_reward/stan_recovery.py
"""
