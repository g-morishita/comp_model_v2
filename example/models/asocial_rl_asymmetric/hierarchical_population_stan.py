...
task = TaskSpec(
    task_id="asocial_rl_asymmetric_hierarchical_population",
    blocks=(
        BlockSpec(
            condition="example",
            n_trials=N_TRIALS,
...
result = fit(inference_config, kernel, dataset, ASOCIAL_BANDIT_SCHEMA, adapter=adapter)
...
print("Hierarchical population sampling + Stan: asocial_rl_asymmetric")
