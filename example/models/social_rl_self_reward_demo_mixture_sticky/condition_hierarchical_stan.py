...
task = TaskSpec(
    task_id="social_rl_self_reward_demo_mixture_sticky_condition_hierarchical",
    blocks=(
        BlockSpec(
            condition="baseline",
            n_trials=N_TRIALS,
...
print()
print("Condition-aware hierarchical Stan: social_rl_self_reward_demo_mixture_sticky")
print(
