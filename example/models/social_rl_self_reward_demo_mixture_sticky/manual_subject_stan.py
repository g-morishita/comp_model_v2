...
task = TaskSpec(
    task_id="social_rl_self_reward_demo_mixture_sticky_manual_subject",
    blocks=(
        BlockSpec(
            condition="example",
            n_trials=N_TRIALS,
...
true_params = SocialRlSelfRewardDemoMixtureStickyParams(
    alpha_self=0.3,
...
print("Manual subject + Stan: social_rl_self_reward_demo_mixture_sticky")
