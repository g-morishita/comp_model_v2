...
task = TaskSpec(
    task_id="social_rl_demo_action_bias_sticky_condition_hierarchical",
    blocks=(
        BlockSpec(
            condition="baseline",
            n_trials=N_TRIALS,
...
prior_specs = {
    ...
    "sd_demo_bias": PriorSpec("normal", {"mu": 0.0, "sigma": 0.5}),
    "demo_bias_delta": PriorSpec("normal", {"mu": 0.4, "sigma": 1.0}),
    "sd_demo_bias_delta": PriorSpec("normal", {"mu": 0.0, "sigma": 0.5}),
...
print()
print("Condition-aware hierarchical Stan: social_rl_demo_action_bias_sticky")
print(
