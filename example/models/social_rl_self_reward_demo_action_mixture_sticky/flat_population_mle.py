...
task = TaskSpec(
    task_id="social_rl_self_reward_demo_action_mixture_sticky_flat_population",
    blocks=(
        BlockSpec(
            condition="example",
            n_trials=N_TRIALS,
...
print("Flat population sampling + MLE: social_rl_self_reward_demo_action_mixture_sticky")
print(header)
print("-" * len(header))
