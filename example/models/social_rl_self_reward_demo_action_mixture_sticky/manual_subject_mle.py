...
task = TaskSpec(
    task_id="social_rl_self_reward_demo_action_mixture_sticky_manual_subject",
    blocks=(
        BlockSpec(
            condition="example",
            n_trials=N_TRIALS,
...
true_params = SocialRlSelfRewardDemoActionMixtureStickyParams(
    alpha_self=0.3,
...
result = fit(inference_config, kernel, subject, SOCIAL_PRE_CHOICE_ACTION_ONLY_SCHEMA)
...
print("Manual subject + MLE: social_rl_self_reward_demo_action_mixture_sticky")
