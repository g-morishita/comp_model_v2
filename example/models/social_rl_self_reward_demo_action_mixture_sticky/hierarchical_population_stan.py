...
task = TaskSpec(
    task_id="social_rl_self_reward_demo_action_mixture_sticky_hierarchical_population",
    blocks=(
        BlockSpec(
            condition="example",
            n_trials=N_TRIALS,
...
result = fit(
    inference_config, kernel, dataset, SOCIAL_PRE_CHOICE_ACTION_ONLY_SCHEMA, adapter=adapter
)
...
print("Hierarchical population sampling + Stan: social_rl_self_reward_demo_action_mixture_sticky")
