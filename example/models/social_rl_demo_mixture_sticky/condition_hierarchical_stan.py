...
Model: social_rl_demo_mixture_sticky
...
task = TaskSpec(
    task_id="social_rl_demo_mixture_sticky_condition_hierarchical",
    blocks=(
        BlockSpec(
            condition="baseline",
            n_trials=N_TRIALS,
...
param_names = ["alpha_other_outcome", "alpha_other_action", "w_imitation", "beta", "stickiness"]
print()
print("Condition-aware hierarchical Stan: social_rl_demo_mixture_sticky")
print(
