...
from comp_model.models.kernels import (
    ...
    SocialRlDemoMixtureStickyParams,
)
...
task = TaskSpec(
    task_id="social_rl_demo_mixture_sticky_manual_subject",
    blocks=(
        BlockSpec(
            condition="example",
            n_trials=N_TRIALS,
...
true_params = SocialRlDemoMixtureStickyParams(
...
print("Manual subject + Stan: social_rl_demo_mixture_sticky")
