...
task = TaskSpec(
    task_id="social_rl_demo_reward_condition_hierarchical",
    blocks=(
        BlockSpec(
            condition="baseline",
            n_trials=N_TRIALS,
...
param_names = ["alpha_other", "beta"]
print()
print("Condition-aware hierarchical Stan: social_rl_demo_reward")
print(
