...
This directory contains fixed example scripts for the `social_rl_demo_reward` model.
...
```bash
uv run python example/models/social_rl_demo_reward/manual_subject_mle.py
```
