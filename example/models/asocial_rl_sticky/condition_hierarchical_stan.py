...
task = TaskSpec(
    task_id="asocial_rl_sticky_condition_hierarchical",
    blocks=(
        BlockSpec(
            condition="baseline",
            n_trials=N_TRIALS,
...
prior_specs = {
    ...
    "sd_alpha": PriorSpec("normal", {"mu": 0.0, "sigma": 0.5}),
    "alpha_delta": PriorSpec("normal", {"mu": 0.619039, "sigma": 1.0}),
    "sd_alpha_delta": PriorSpec("normal", {"mu": 0.0, "sigma": 0.5}),
...
print()
print("Condition-aware hierarchical Stan: asocial_rl_sticky")
print(
