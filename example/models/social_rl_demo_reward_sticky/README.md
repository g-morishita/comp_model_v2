...
This directory contains fixed example scripts for the `social_rl_demo_reward_sticky` model.
...
```bash
uv run python example/models/social_rl_demo_reward_sticky/manual_subject_mle.py
```
