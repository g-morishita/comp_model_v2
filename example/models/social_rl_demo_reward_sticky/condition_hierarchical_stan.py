...
task = TaskSpec(
    task_id="social_rl_demo_reward_sticky_condition_hierarchical",
    blocks=(
        BlockSpec(
            condition="baseline",
            n_trials=N_TRIALS,
...
prior_specs = {
    ...
    "sd_alpha_other": PriorSpec("normal", {"mu": 0.0, "sigma": 0.5}),
    "alpha_other_delta": PriorSpec("normal", {"mu": 0.606136, "sigma": 1.0}),
    "sd_alpha_other_delta": PriorSpec("normal", {"mu": 0.0, "sigma": 0.5}),
...
print()
print("Condition-aware hierarchical Stan: social_rl_demo_reward_sticky")
print(
