...
task = TaskSpec(
    task_id="social_rl_self_reward_demo_action_mixture_hierarchical_population",
    blocks=(
        BlockSpec(
            condition="example",
            n_trials=N_TRIALS,
...
print("Hierarchical population sampling + Stan: social_rl_self_reward_demo_action_mixture")
