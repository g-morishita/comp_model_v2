...
This directory contains fixed example scripts for the `social_rl_self_reward_demo_action_mixture` model.
...
```bash
uv run python example/models/social_rl_self_reward_demo_action_mixture/manual_subject_mle.py
```
