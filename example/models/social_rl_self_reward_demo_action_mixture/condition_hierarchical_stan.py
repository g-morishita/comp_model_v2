...
task = TaskSpec(
    task_id="social_rl_self_reward_demo_action_mixture_condition_hierarchical",
    blocks=(
        BlockSpec(
            condition="baseline",
            n_trials=N_TRIALS,
...
print()
print("Condition-aware hierarchical Stan: social_rl_self_reward_demo_action_mixture")
print(
