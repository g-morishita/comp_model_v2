...
task = TaskSpec(
    task_id="social_rl_self_reward_demo_action_mixture_manual_subject",
    blocks=(
        BlockSpec(
            condition="example",
            n_trials=N_TRIALS,
...
true_params = SocialRlSelfRewardDemoActionMixtureParams(
    alpha_self=0.3,
...
param_names = ["alpha_self", "alpha_other_action", "w_imitation", "beta"]
true_values = {
    "alpha_self": 0.3,
    "alpha_other_action": 0.35,
    "w_imitation": 0.65,
...
print("Manual subject + MLE: social_rl_self_reward_demo_action_mixture")
