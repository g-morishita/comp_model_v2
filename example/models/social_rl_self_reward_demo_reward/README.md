...
This directory contains fixed example scripts for the `social_rl_self_reward_demo_reward` model.
...
```bash
uv run python example/models/social_rl_self_reward_demo_reward/manual_subject_mle.py
```
