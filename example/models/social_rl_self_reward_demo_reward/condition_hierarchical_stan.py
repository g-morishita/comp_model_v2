...
Model: social_rl_self_reward_demo_reward
...
task = TaskSpec(
    task_id="social_rl_self_reward_demo_reward_condition_hierarchical",
    blocks=(
        BlockSpec(
            condition="baseline",
            n_trials=N_TRIALS,
...
param_names = ["alpha_self", "alpha_other", "beta"]
print()
print("Condition-aware hierarchical Stan: social_rl_self_reward_demo_reward")
print(
